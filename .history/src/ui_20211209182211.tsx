...
>
{
  ...
  render(this) {
    ...
    if (this.state.disable == 'true') {
      return (
        <DisableBtn value={this.state.value} />
      )
    ...
    return (
      // 可点击状态
      <Btn value={this.state.value} ln={this.state.layerName} />
    )
  }
    ...
    if (this.state.layerName == '') {
      return (
        ...
        <div>
          ...
          <BottomBtn disable='true' value='Run' layerName='' />
        </div>
      )
    }
